    ...
    <div class="container">
        ...
        <form class="col s12 m12 l12" action="/editUserProfile" method="post">
            ...
            <div class="row center">
                ...
                <button class="btn pink darken-1" type="submit" name="edit"><i class="material-icons">update</i>Edit</button>
            </div>
        </form>
        <div class="row center">
            <form action="/tweetFeed" method="get">
                <input type="hidden" name="userId" value="{{$userId}}">
                <button class="btn pink darken-1" type="submit" name="cancel"><i class="material-icons">close</i>Cancel</button>
            </form>
        </div>
    </div>
@endsection
